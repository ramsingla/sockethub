    ...
    this.session.getConfig('credentials').then(function(credentials) {
      try {
        ...
        openInbox(function(err, box) {
          var from =  options.from || options.page*options.perPage,
              to = options.to || /* from+options.perPage || */ box.messages.total;
          if (from > box.messages.total) {
            from = box.messages.total;
          }
          if (to > box.messages.total) {
            to = box.messages.total;
          }
